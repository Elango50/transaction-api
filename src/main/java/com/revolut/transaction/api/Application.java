package com.revolut.transaction.api;
...
import com.revolut.transaction.api.service.UserService;
...
public class Application {
	...
	private static void startService() throws Exception {
		...
		servletHolder.setInitParameter("jersey.config.server.provider.classnames",
				AccountService.class.getCanonicalName() + "," + UserService.class.getCanonicalName() + ","
