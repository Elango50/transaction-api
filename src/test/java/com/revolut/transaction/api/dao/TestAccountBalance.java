...
public class TestAccountBalance {
	...
	public void testAccountSingleThreadSameCcyTransfer() throws TransactionException {
		...
		TransactionDetails transaction = new TransactionDetails("EUR", transferAmount, 3L, 4L);
	...
	public void testAccountMultiThreadedTransfer() throws InterruptedException, TransactionException {
		...
		for (int i = 0; i < THREADS_COUNT; i++) {
			new Thread(new Runnable() {
				...
				public void run() {
					try {
						TransactionDetails transaction = new TransactionDetails("USD",
	...
	public void testTransferFailOnDBLock() throws TransactionException, SQLException {
		...
		try {
			...
			TransactionDetails transaction = new TransactionDetails("GBP", transferAmount, 6L, 5L);
