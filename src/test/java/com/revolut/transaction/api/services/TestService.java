...
import com.revolut.transaction.api.service.AccountService;
import com.revolut.transaction.api.service.ServiceExceptionMapper;
import com.revolut.transaction.api.service.TransactionService;
    ...
    private static void startServer() throws Exception {
        if (server == null) {
            ...
            servletHolder.setInitParameter("jersey.config.server.provider.classnames",
                    AccountService.class.getCanonicalName() + "," + ServiceExceptionMapper.class.getCanonicalName()
