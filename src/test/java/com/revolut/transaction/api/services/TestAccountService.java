 ...
 * <p>
 * INSERT INTO Account (UserName,Balance,CurrencyCode) VALUES
 * ('test2',100.0000,'USD'); --ID =1 INSERT INTO Account
 * (UserName,Balance,CurrencyCode) VALUES ('test1',200.0000,'USD'); --ID =2
 * INSERT INTO Account (UserName,Balance,CurrencyCode) VALUES
 * ('test2',500.0000,'EUR'); --ID =3 INSERT INTO Account
 * (UserName,Balance,CurrencyCode) VALUES ('test1',500.0000,'EUR'); --ID =4
 */
