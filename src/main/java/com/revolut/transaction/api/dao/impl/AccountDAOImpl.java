package com.revolut.transaction.api.dao.impl;
...
import com.revolut.transaction.api.dao.AccountDAO;
import com.revolut.transaction.api.dao.H2DAOFactory;
...
public class AccountDAOImpl implements AccountDAO {
	...
	public int updateAccountBalance(long accountId, BigDecimal deltaAmount) throws TransactionException {
		...
		try {
			...
			if (balance.compareTo(ConverterUtil.zeroAmount) < 0) {
	 ...
	 */
	public int transferAccountBalance(TransactionDetails userTransaction) throws TransactionException {
		int result = -1;
		Connection conn = null;
		PreparedStatement lockStmt = null;
		PreparedStatement updateStmt = null;
		...
		try {
			...
			if (fromAccountLeftOver.compareTo(ConverterUtil.zeroAmount) < 0) {
