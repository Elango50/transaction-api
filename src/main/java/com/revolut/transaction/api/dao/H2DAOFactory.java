...
import com.revolut.transaction.api.dao.impl.AccountDAOImpl;
import com.revolut.transaction.api.dao.impl.UserDAOImpl;
import com.revolut.transaction.api.utils.Utils;
...
public class H2DAOFactory extends DAOFactory {
	...
	public void populateTestData() {
		...
		try {
			...
			RunScript.execute(conn, new FileReader("src/test/resources/transaction-api.sql"));
